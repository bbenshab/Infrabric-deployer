...
## Table of Contents
- [How It Works: Dynamic Version Discovery + User Customization](#how-it-works-dynamic-version-discovery--user-customization)
- [User Customization](#user-customization)
- [What Gets Auto-Discovered vs User-Controlled](#what-gets-auto-discovered-vs-user-controlled)
- [Example Customizations](#example-customizations)
- [Viewing Current Configuration](#viewing-current-configuration)
- [Troubleshooting](#troubleshooting)
- [Benefits of This Approach](#benefits-of-this-approach)
- [Alternative: Pin Specific Version](#alternative-pin-specific-version)
...
nodeAffinity:
  requiredDuringSchedulingIgnoredDuringExecution:
    ...
    - matchExpressions:
      ...
      - key: network.fab-rig/roce-enabled
        operator: Exists
```
...
If `irdma` module is loaded, apply the workaround in `rig/baremetal/README.md`.

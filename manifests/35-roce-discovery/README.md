...
**Note:** In "separate" mode, route destinations are automatically incremented per NIC (192.168.75.0/24 → 192.168.76.0/24 → 192.168.77.0/24, etc.) to avoid routing ambiguity and ensure optimal parallel performance.
